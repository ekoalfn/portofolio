...
class WebController extends Controller
{
    ...
    //   Artisan::call('config:clear');
        ...
        SEOTools::opengraph()->setUrl('https://ekoalfianto.my.id');
        SEOTools::setCanonical('https://ekoalfianto.my.id');
        SEOTools::opengraph()->addProperty('type', 'articles');

        SEOTools::jsonLd()->addImage('https://ekoalfianto.my.id/web/img/yan-afriyoko.png');
    ...
    public function portofolio()
    {
        ...
        SEOTools::setCanonical('https://ekoalfianto.my.id');
        SEOTools::opengraph()->addProperty('type', 'articles');
        SEOTools::jsonLd()->addImage('https://ekoalfianto.my.id/web/img/photos/fullstack-developer-dimas.png');
